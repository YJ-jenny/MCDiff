...
class TrainLoop:
    ...
    def forward_backward(self, data):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            tr_p = TR[i : i + self.microbatch].to(dist_util.dev())
            te_p = TE[i : i + self.microbatch].to(dist_util.dev())
            ti_p = TI[i : i + self.microbatch].to(dist_util.dev())
            ...
            compute_losses3 = functools.partial(
                self.diffusion.training_losses,
                self.ddp_model,
                micro,
                t,
            ...
            if last_batch or not self.use_ddp:
                losses, feature = compute_losses()
                losses2, feature2 = compute_losses2()
                losses3, feature3 = compute_losses3()
            else:
            ...
            feature_en = F.normalize(feature_en,p=2,dim=1)
            
            feature1 =  F.normalize(feature,p=2,dim=1)
